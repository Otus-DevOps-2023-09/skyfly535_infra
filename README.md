...
8. создан дополнительный клон инстанса с веб приложением при помощи параметра ресурса `count`;
...
resource "yandex_compute_instance" "app" {
  ...
  ...
```
7. Создан `Network Load Balancer` и настроена балансировка между инстансами веб приложения;
...
```
8. Проверена работа балансировщика с неработающим одним сервером.
